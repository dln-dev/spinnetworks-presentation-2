...
\begin{frame}[t]{Spin Switch}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.5\textwidth}
			\centering
    		%\includegraphics[trim=0mm 0 0 0mm, width=1.2\textwidth]{Images/switch_labeled}
		\end{column}
	\end{columns}
...
\begin{frame}{Spin Switch with more Arms}
	...
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
   			\centering
   			%\includegraphics[trim=0mm 0 0 0mm, width=1.2\textwidth]{Images/switch4_labeled}
		\end{column}
		\begin{column}{0.5\textwidth}
			\centering
    		$H = \begin{pmatrix}
...
\begin{frame}[t]{Varying Couplings}
	...
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
			\centering
			Weighted graphs
   			%\includegraphics[trim=0mm 0 0 0mm, width=\textwidth]{Images/graph_vary}
		\end{column}
		\begin{column}{0.5\textwidth}
			\centering
			Weighted adjacency matrices
   			%\includegraphics[trim=0mm 0 0 0mm, width=\textwidth]{Images/adj_vary}
		\end{column}
	\end{columns}
...
\begin{frame}[t]{Perfect Couplings}
	\centering
	%\includegraphics[trim=0mm 0 0 0mm, width=\textwidth]{Images/chain_perf}
	\begin{itemize}
...
\end{pmatrix}$
		...
		\begin{column}{0.5\textwidth}
			\centering
   			%\includegraphics[trim=0mm 0 0 0mm, width=\textwidth]{Images/adj_chain6_1_perf}
		\end{column}
	\end{columns}
%    Local couplings leads to much more variety, spin chains with perfect couplings (isomorphism of hilbert spaces to spin n-something particle), not yet looked at switch
\end{frame}
